package com.test.activiti.secirity;
...
//        return new User(username, passwordEncoder.encode("111"), AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE_ACTIVITI_USER"));
//    }
